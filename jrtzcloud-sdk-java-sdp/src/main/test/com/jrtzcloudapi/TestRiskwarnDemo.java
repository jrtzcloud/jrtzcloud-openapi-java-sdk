...
public class TestRiskwarnDemo {
    private final static Charset UTF8 = StandardCharsets.UTF_8;

    private final static String SECRET_ID = "RiskwarnDevRiskwarnDeRiskwarnDev";
    private final static String SECRET_KEY = "OOpZmUGqYyX3TvHtFDVPMv1YuXU4Lcay";
...
//        String timestamp = "1584959350";
        ...
        String service = "riskwarn";
        String host = "riskwarn.jrtzcloud.cn";
        String canonicalUri = "/riskwarn/composite/all-risk-type-count";
