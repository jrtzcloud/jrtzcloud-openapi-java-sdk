...
public class SetSelfStock {
    ...
    public static final String PATH = "/sdp-cust/externalCall/setSelfStock";
...
//            httpProfile.setReqMethod("GET"); // get请求(默认为post请求)
            ...
            SetSelfStockRequest req = new SetSelfStockRequest();

            // 填充请求参数,这里request对象的成员变量即对应接口的入参
            req.setAccountId("1001");
            req.setAppId("001");
            req.setIsDeleted(1);
            req.setStockCode("600000");
            ...
            SetSelfStockResponse resp = client.SetSelfStock(req);

            System.out.println("\n");

            // 输出json格式的字符串回包
            System.out.println(SetSelfStockResponse.toJsonString(resp));
