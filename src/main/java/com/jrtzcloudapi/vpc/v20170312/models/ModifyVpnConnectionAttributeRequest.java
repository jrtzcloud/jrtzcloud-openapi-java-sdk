...
public class ModifyVpnConnectionAttributeRequest  extends AbstractModel{
    ...
    */
    ...
    /**
     * 获取IPSec配置，今日投资云提供IPSec安全会话设置。
     * @return IPSECOptionsSpecification IPSec配置，今日投资云提供IPSec安全会话设置。
     */
    ...
    /**
     * 设置IPSec配置，今日投资云提供IPSec安全会话设置。
     * @param IPSECOptionsSpecification IPSec配置，今日投资云提供IPSec安全会话设置。
     */
