...
public class DescribeInstancesStatusResponse  extends AbstractModel{
    ...
    */
    ...
    /**
    * [实例状态](https://www.jrtzcloud.cn/document/api/213/15738) 列表。
    */
    ...
    */
    ...
    /**
     * 获取[实例状态](https://www.jrtzcloud.cn/document/api/213/15738) 列表。
     * @return InstanceStatusSet [实例状态](https://www.jrtzcloud.cn/document/api/213/15738) 列表。
     */
    ...
    /**
     * 设置[实例状态](https://www.jrtzcloud.cn/document/api/213/15738) 列表。
     * @param InstanceStatusSet [实例状态](https://www.jrtzcloud.cn/document/api/213/15738) 列表。
     */
