...
public class ResetInstanceRequest  extends AbstractModel{
    ...
    /**
    * 实例ID。可通过 [DescribeInstances](https://www.jrtzcloud.cn/document/api/213/9388) API返回值中的`InstanceId`获取。
    */
...
<br>默认取值：默认使用当前镜像。
    ...
    */
    ...
    /**
     * 获取实例ID。可通过 [DescribeInstances](https://www.jrtzcloud.cn/document/api/213/9388) API返回值中的`InstanceId`获取。
     * @return InstanceId 实例ID。可通过 [DescribeInstances](https://www.jrtzcloud.cn/document/api/213/9388) API返回值中的`InstanceId`获取。
     */
    ...
    /**
     * 设置实例ID。可通过 [DescribeInstances](https://www.jrtzcloud.cn/document/api/213/9388) API返回值中的`InstanceId`获取。
     * @param InstanceId 实例ID。可通过 [DescribeInstances](https://www.jrtzcloud.cn/document/api/213/9388) API返回值中的`InstanceId`获取。
     */
