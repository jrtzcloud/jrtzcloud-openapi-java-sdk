...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    */
    ...
    /**
    * 实例所属安全组。该参数可以通过调用 [DescribeSecurityGroups](https://www.jrtzcloud.cn/document/api/215/15808) 的返回值中的sgId字段来获取。
    */
...
注意：此字段可能返回 null，表示取不到有效值。
    ...
    /**
     * 获取实例所属安全组。该参数可以通过调用 [DescribeSecurityGroups](https://www.jrtzcloud.cn/document/api/215/15808) 的返回值中的sgId字段来获取。
     * @return SecurityGroupIds 实例所属安全组。该参数可以通过调用 [DescribeSecurityGroups](https://www.jrtzcloud.cn/document/api/215/15808) 的返回值中的sgId字段来获取。
     */
    ...
    /**
     * 设置实例所属安全组。该参数可以通过调用 [DescribeSecurityGroups](https://www.jrtzcloud.cn/document/api/215/15808) 的返回值中的sgId字段来获取。
     * @param SecurityGroupIds 实例所属安全组。该参数可以通过调用 [DescribeSecurityGroups](https://www.jrtzcloud.cn/document/api/215/15808) 的返回值中的sgId字段来获取。
     */
