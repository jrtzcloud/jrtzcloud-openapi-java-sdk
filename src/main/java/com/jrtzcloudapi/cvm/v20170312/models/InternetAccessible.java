...
public class InternetAccessible  extends AbstractModel{
    ...
    */
    ...
    /**
    * 公网出带宽上限，单位：Mbps。默认值：0Mbps。不同机型带宽上限范围不一致，具体限制详见[购买网络带宽](https://www.jrtzcloud.cn/document/product/213/12523)。
    */
    ...
    */
    ...
    /**
    * 带宽包ID。可通过[`DescribeBandwidthPackages`](https://www.jrtzcloud.cn/document/api/215/19209)接口返回值中的`BandwidthPackageId`获取。该参数仅在RunInstances接口中作为入参使用。
    */
    ...
    /**
     * 获取公网出带宽上限，单位：Mbps。默认值：0Mbps。不同机型带宽上限范围不一致，具体限制详见[购买网络带宽](https://www.jrtzcloud.cn/document/product/213/12523)。
     * @return InternetMaxBandwidthOut 公网出带宽上限，单位：Mbps。默认值：0Mbps。不同机型带宽上限范围不一致，具体限制详见[购买网络带宽](https://www.jrtzcloud.cn/document/product/213/12523)。
     */
    ...
    /**
     * 设置公网出带宽上限，单位：Mbps。默认值：0Mbps。不同机型带宽上限范围不一致，具体限制详见[购买网络带宽](https://www.jrtzcloud.cn/document/product/213/12523)。
     * @param InternetMaxBandwidthOut 公网出带宽上限，单位：Mbps。默认值：0Mbps。不同机型带宽上限范围不一致，具体限制详见[购买网络带宽](https://www.jrtzcloud.cn/document/product/213/12523)。
     */
    ...
    /**
     * 获取带宽包ID。可通过[`DescribeBandwidthPackages`](https://www.jrtzcloud.cn/document/api/215/19209)接口返回值中的`BandwidthPackageId`获取。该参数仅在RunInstances接口中作为入参使用。
     * @return BandwidthPackageId 带宽包ID。可通过[`DescribeBandwidthPackages`](https://www.jrtzcloud.cn/document/api/215/19209)接口返回值中的`BandwidthPackageId`获取。该参数仅在RunInstances接口中作为入参使用。
     */
    ...
    /**
     * 设置带宽包ID。可通过[`DescribeBandwidthPackages`](https://www.jrtzcloud.cn/document/api/215/19209)接口返回值中的`BandwidthPackageId`获取。该参数仅在RunInstances接口中作为入参使用。
     * @param BandwidthPackageId 带宽包ID。可通过[`DescribeBandwidthPackages`](https://www.jrtzcloud.cn/document/api/215/19209)接口返回值中的`BandwidthPackageId`获取。该参数仅在RunInstances接口中作为入参使用。
     */
