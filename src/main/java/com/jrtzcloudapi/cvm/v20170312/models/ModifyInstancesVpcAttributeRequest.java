...
public class ModifyInstancesVpcAttributeRequest  extends AbstractModel{
    ...
    /**
    * 待操作的实例ID数组。可通过[`DescribeInstances`](https://www.jrtzcloud.cn/document/api/213/15728)接口返回值中的`InstanceId`获取。
    */
    ...
    */
    ...
    /**
     * 获取待操作的实例ID数组。可通过[`DescribeInstances`](https://www.jrtzcloud.cn/document/api/213/15728)接口返回值中的`InstanceId`获取。
     * @return InstanceIds 待操作的实例ID数组。可通过[`DescribeInstances`](https://www.jrtzcloud.cn/document/api/213/15728)接口返回值中的`InstanceId`获取。
     */
    ...
    /**
     * 设置待操作的实例ID数组。可通过[`DescribeInstances`](https://www.jrtzcloud.cn/document/api/213/15728)接口返回值中的`InstanceId`获取。
     * @param InstanceIds 待操作的实例ID数组。可通过[`DescribeInstances`](https://www.jrtzcloud.cn/document/api/213/15728)接口返回值中的`InstanceId`获取。
     */
