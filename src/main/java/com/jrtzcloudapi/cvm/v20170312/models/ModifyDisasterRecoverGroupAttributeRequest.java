...
public class ModifyDisasterRecoverGroupAttributeRequest  extends AbstractModel{
    ...
    /**
    * 分散置放群组ID，可使用[DescribeDisasterRecoverGroups](https://www.jrtzcloud.cn/document/api/213/17810)接口获取。
    */
    ...
    */
    ...
    /**
     * 获取分散置放群组ID，可使用[DescribeDisasterRecoverGroups](https://www.jrtzcloud.cn/document/api/213/17810)接口获取。
     * @return DisasterRecoverGroupId 分散置放群组ID，可使用[DescribeDisasterRecoverGroups](https://www.jrtzcloud.cn/document/api/213/17810)接口获取。
     */
    ...
    /**
     * 设置分散置放群组ID，可使用[DescribeDisasterRecoverGroups](https://www.jrtzcloud.cn/document/api/213/17810)接口获取。
     * @param DisasterRecoverGroupId 分散置放群组ID，可使用[DescribeDisasterRecoverGroups](https://www.jrtzcloud.cn/document/api/213/17810)接口获取。
     */
