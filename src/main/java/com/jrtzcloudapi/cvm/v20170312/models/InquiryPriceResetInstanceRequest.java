...
public class InquiryPriceResetInstanceRequest  extends AbstractModel{
    ...
    /**
    * 实例ID。可通过 [DescribeInstances](https://www.jrtzcloud.cn/document/api/213/15728) API返回值中的`InstanceId`获取。
    */
    ...
    */
    ...
    /**
     * 获取实例ID。可通过 [DescribeInstances](https://www.jrtzcloud.cn/document/api/213/15728) API返回值中的`InstanceId`获取。
     * @return InstanceId 实例ID。可通过 [DescribeInstances](https://www.jrtzcloud.cn/document/api/213/15728) API返回值中的`InstanceId`获取。
     */
    ...
    /**
     * 设置实例ID。可通过 [DescribeInstances](https://www.jrtzcloud.cn/document/api/213/15728) API返回值中的`InstanceId`获取。
     * @param InstanceId 实例ID。可通过 [DescribeInstances](https://www.jrtzcloud.cn/document/api/213/15728) API返回值中的`InstanceId`获取。
     */
