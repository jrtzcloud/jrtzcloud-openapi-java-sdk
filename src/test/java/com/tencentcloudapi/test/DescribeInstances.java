...
public class DescribeInstances {
    public static void main(String[] args) {
        try {
            ...
            Credential cred = new Credential("AKIDRHUO70VGLbgbMxRbGlRxXSC3tZKxshpn",
                                            "117bvELH2iHVM3Zu56zzbpeIm5DWM5b2");
...
//            String params = "{\"Filters\":[{\"Name\":\"zone\",\"Values\":[\"ap-shanghai-1\",\"ap-shanghai-2\"]}]}";
            String params = "{\"Limit\": 1, \"Filters\": [{\"Values\": [\"\\u672a\\u547d\\u540d\"], \"Name\": \"instance-name\"}]}";
